    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="shrink-0">
                    <img class="size-8" src="{{ asset('img/gambar.jpg') }}"
                        alt="Your Company" style="border-radius: 50%">
        ...
        -->
            ...
            <div class="-mr-2 flex md:hidden">
                ...
                <button type="button" @click="isOpen = !isOpen"
                    ...
                    <svg :class="{ 'hiiden': isOpen, 'block': !isOpen }" class="block size-6" fill="none"
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base/5 font-medium text-white">FATZ DEV</div>
                    <div class="text-sm font-medium text-gray-400">FATZDEV@example.com</div>
                </div>
            </div>
