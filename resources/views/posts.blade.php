    ...
    <div class="my-4 py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($posts as $post)
                <article
                    class="p-6 bg-white rounded-lg border border-gray-400 shadow-xl dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex justify-between items-center mb-5 text-gray-500">
                        <a href="/posts?catagory={{ $post->category->slug }}">
                            <span
            ...
            @empty
                <div class="">
                    ...
                    <a class="block text-blue-600 hover:underline" href="/posts">&laquo; Back To All Post</a>
                </div>
            @endforelse
        </div>
    </div>
